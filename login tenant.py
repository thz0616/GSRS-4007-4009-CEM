...
def registerWindow():
    ...
    ICLabel = Label(registerFrame, text="I/C: ", font= ("Verdana", 25, "bold"))
    ICLabel.place(x=100, y=330)

    ICEntry = Entry(registerFrame, font= ("Verdana", 25),width=300)
    ICEntry.place(x=300, y=330)
